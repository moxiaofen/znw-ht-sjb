  ...
  <div>
    ...
    <div class="content">
     <div class="item">
      ...
      <!--已入池应收账款可用余额-->
      <div class='top'>
        <span class='inputLable'>已入池应收账款可用余额</span>
        <input class='inputVal' type="text" ref="rApplyAmt" v-model="vApplyAmt" placeholder="请输入已入池应收账款可用余额" />
      ...
      <!-- 应收款清单列表 -->
      <add-receivables-list :itemShow='false' :receivablesList='receivablesList'></add-receivables-list>
