...
const BusinessApplyChange = '/business/BusinessApplyChange'//业务申请
const BusinessApplyDetail = '/business/BusinessApplyDetail'//业务申请详情
const DraftApply = '/draft/DraftApply'//业务申请
const DraftApplyDetail = '/draft/DraftApplyDetail'//业务申请详情
